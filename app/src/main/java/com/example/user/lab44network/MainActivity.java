...
import com.example.user.lab44network.Model.CourseAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_settings) {
            ...
            downloadCourse(getApplicationContext(), getString(R.string.get_course_url));
        }
                    ...
                    public void onResponse(JSONArray response) {
                        try {
                            ...
                            for (int i = 0; i < response.length(); i++) {
                                ...
                                //add data into constructor
                                Course course = new Course(code, title, credit);
                                //add the course into list
                                caList.add(course);
                            }
                            loadCourse();
                            if (pDialog.isShowing())
